...
拥有 8 亿用户的钉钉为此完成了底层代码重写，进行了**全面的 CLI 化改造**[^11]——悟空原生操作钉钉的上千项能力，而非模拟人类点击。值得注意的是，这次的 CLI 是专门为 AI 设计的：命令可以很长很详细（AI 不需要记），输出直接是 JSON（AI 解析结构化数据比看排版高效得多）。结合[第一篇](/posts/cli-vs-mcp-vs-skills/)的分析，这验证了 CLI 在 Agent 工具调用中的效率优势。阿里旗下淘宝、天猫、1688、支付宝、阿里云等 B 端能力以 Skill 形式逐步接入，首批覆盖十大行业场景[^4]。AI Agent 自动继承企业权限规则，绕过了[第二篇](/posts/agent-bottleneck-data-sovereignty/)分析的"组织管控"壁垒。
...
欧盟 DMA（数字市场法案）已经产生了实际执法效果[^12]：

- **6 家守门人**被指定：Alphabet、Amazon、Apple、ByteDance、Meta、Microsoft（2023 年 9 月）
- 2025 年 4 月开出**首张罚单**：苹果 5 亿欧元（限制 App Store 开放）+ Meta 2 亿欧元（强制"付费去广告"）= 合计 7 亿欧元
- 最高处罚可达全球年营收的 **10%**（重复违规 20%）
- **第 7 条**强制即时通讯服务互操作（WhatsApp、Messenger 须开放跨平台消息）
- 苹果和谷歌已被迫开放跨平台数据迁移（iOS 26.3 测试版新增"传输至安卓"功能）

国内的《个人信息保护法》第 45 条也规定了数据可携带权——用户有权请求将个人信息转移至其指定的其他处理者。但目前的执法重心在隐私保护（打击"开盒"、人脸识别滥用等），尚未出现以数据可携带权强制平台向第三方 Agent 开放数据的案例。

**差距很明显：欧盟在用罚款倒逼开放，国内的数据可携带条款还基本停留在纸面上。** 如果国内出台类似 DMA 的执行力度，那才是真正的转折点。
...
[^12]: 欧盟 DMA 执法数据：2025 年 4 月 23 日首次开出罚单，苹果 5 亿欧元 + Meta 2 亿欧元，合计 7 亿欧元。参见 36 氪，["7 亿欧元，欧盟对苹果和 Meta 开出《数字市场法案》首张罚单"](https://www.36kr.com/p/3263607955078913)；安全内参，["欧盟《数字市场法》大考结束，六大守门人都交了什么合规答卷"](https://www.secrss.com/articles/88435)，2026 年 3 月。中国《个人信息保护法》第 45 条规定数据可携带权，但目前执法集中在隐私保护领域，参见最高检 2026 年 1 月发布的[个人信息保护检察公益诉讼典型案例](http://www.news.cn/government/20260123/f95a39d03b7649c08fe143b3450cac34/c.html)。
